...
async def main():
    ...
    # Rewrite all home.html links to index.html across every saved file
    print(f"\nRewriting home.html -> index.html links...")
    for fname in os.listdir(OUTPUT_DIR):
        if fname.endswith(".html"):
            fpath = os.path.join(OUTPUT_DIR, fname)
            with open(fpath, "r", encoding="utf-8") as f:
                content = f.read()
            updated = content.replace('href="home.html"', 'href="index.html"')
    ...
    if os.path.exists(home):
        ...
        print(f"Renamed home.html -> index.html")
